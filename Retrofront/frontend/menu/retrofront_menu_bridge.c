...
static const retrofront_menu_driver_descriptor_t retrofront_menu_drivers[] = {
   { "ozone",      "drivers/ozone.c",      RETROFRONT_MENU_LAYOUT_OZONE,      0x00adefff, 0x101820ff, 50, 46, 408, 320 },
   { "xmb",        "drivers/xmb.c",        RETROFRONT_MENU_LAYOUT_XMB,        0xffcc00ff, 0x111128ff, 64, 54, 260, 384 },
   { "materialui", "drivers/materialui.c", RETROFRONT_MENU_LAYOUT_MATERIALUI, 0x2196f3ff, 0x202124ff, 56, 40,   0, 256 },
   { "rgui",       "drivers/rgui.c",       RETROFRONT_MENU_LAYOUT_RGUI,       0x00ff00ff, 0x000000ff, 16,  8,   0,   0 }
};
