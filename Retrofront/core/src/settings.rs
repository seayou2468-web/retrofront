...
impl Settings {
    ...
    fn apply_retroarch_defaults(&mut self, base_dir: &Path) {
        let defaults = [
            ...
            ("ozone_show_sidebar", PathBuf::from("true")),
            ("ozone_header_style", PathBuf::from("icon_separator")),
            ("ozone_padding_factor", PathBuf::from("1.0")),
            ("ozone_font_scale", PathBuf::from("1.0")),
            ("ozone_thumbnail_scale_factor", PathBuf::from("1.0")),
            ("materialui_icons_enable", PathBuf::from("true")),
            ("materialui_switch_icons", PathBuf::from("true")),
            ("materialui_show_nav_bar", PathBuf::from("true")),
            ("materialui_auto_rotate_nav_bar", PathBuf::from("true")),
            (
                "materialui_dual_thumbnail_list_view_enable",
                PathBuf::from("true"),
            ),
            ("rgui_menu_theme_preset", PathBuf::from("default")),
            ("rgui_aspect_ratio", PathBuf::from("auto")),
            ("rgui_inline_thumbnails", PathBuf::from("false")),
            ("rgui_extended_ascii", PathBuf::from("true")),
            ("rgui_full_width_layout", PathBuf::from("true")),
            ("xmb_theme", PathBuf::from("monochrome")),
            ("xmb_show_horizontal_list", PathBuf::from("true")),
            ("xmb_shadows_enable", PathBuf::from("true")),
            ("xmb_alpha_factor", PathBuf::from("75")),
            ("xmb_layout", PathBuf::from("auto")),
            ...
            ("quick_menu_style", PathBuf::from("retroarch_fullscreen")),
            ...
            ("state_slot", PathBuf::from("0")),
            ("savestate_auto_index", PathBuf::from("false")),
            ("savestate_max_keep", PathBuf::from("0")),
